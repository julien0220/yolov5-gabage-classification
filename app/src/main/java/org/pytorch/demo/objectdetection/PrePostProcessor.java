...
public class PrePostProcessor {
    ...
    private static int mOutputColumn = 49; // left, top, right, bottom, score and 80 class probability
    ...
    static ArrayList<Result> outputsToNMSPredictions(float[] outputs, float imgScaleX, float imgScaleY, float ivScaleX,
